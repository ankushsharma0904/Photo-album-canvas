...
// Function to load image from dropdown selection
function loadImage(imageName) {
    // Set the source of the image based on the selected image name
...
// Function to update the image along with all the filter values
...
function createAvatar() {
    ...
    // Define the size and position of the avatar
    ...
    // Draw the avatar image to the canvas
    context.drawImage(image, avatarX, avatarY, avatarSize, avatarSize);
}


// Function to create thumbnails of the images
function createThumbnail() {
    ...
    // Draw the thumbnail image to the canvas
